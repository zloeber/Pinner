...
| Pattern | Use when |
|---------|----------|
| [core-audit-progress.md](core-audit-progress.md) | Adding or changing `AuditProgress` / `AuditEvent` emission, rayon parallel audit, or stable finding order |
| [core-gitignore-discovery.md](core-gitignore-discovery.md) | Wiring `RepoIgnore` into `discover_manifests` / discovery for pin/check/audit/explain |
